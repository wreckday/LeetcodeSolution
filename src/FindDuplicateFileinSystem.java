...
//                map.put(name_cont[1], list);
    ...
    public static void main(String[] args){
        String[] inputs = {"root/a 1.txt(abcd) 2.txt(efgh)", "root/c 3.txt(abcd)", "root/c/d 4.txt(efgh)", "root 4.txt(efgh)"};
        Common.printNestedStringList(findDuplicate(inputs));
    }
}
